      ...
      <el-tabs v-model="activeMission">
        <el-tab-pane label="图表" name="charts">
          <div style="
                  ...
                  height:625px;
                  overflow-y:auto;">
            <div id="trafficCapacity" :style="{width: '280px', height: '300px'}">
            </div>
            <div id="uploadSpeed" :style="{width: '280px', height: '300px'}">
            </div>
            <div id="downloadSpeed" :style="{width: '280px', height: '300px'}">
            </div>
            <div id="networkDelay" :style="{width: '280px', height: '300px'}">
            </div>
          </div>
        </el-tab-pane>
        <el-tab-pane label="操作" name="operate">
          ...
          <el-select v-model="missionValue" placeholder="请选择任务">
            <el-option v-for="item in missionList" :key="item" :label="item" :value="item">
            </el-option>
          </el-select>
          <el-button style="margin-top:50px;" type="primary" round @click="SubmitChange">
            确认变更
          </el-button>
        </el-tab-pane>
      </el-tabs>
    </el-main>
    <el-main style="width:1100px;">
      <h4>实际部署对比表</h4>
      <el-table :data="positionTable" style="width: 100%;">
        <el-table-column prop="name" label="设备名称" align="center" width="150">
        </el-table-column>
        <el-table-column align="center" prop="set_longitude" label="预设经度" width="150">
        </el-table-column>
        <el-table-column prop="set_latitude" align="center" label="预设纬度" width="150">
        </el-table-column>
        <el-table-column prop="cur_longitude" align="center" label="实际经度" width="150">
        </el-table-column>
        <el-table-column prop="cur_latitude" align="center" label="实际纬度" width="150">
        </el-table-column>
        <el-table-column prop="dif_longitude" align="center" label="经度差值" width="150">
        </el-table-column>
        <el-table-column prop="dif_latitude" align="center" label="纬度差值" width="150">
        </el-table-column>
      </el-table>
      ...
      <el-table :data="deviceWorkingTable" style="width: 100%">
        ...
        <el-table-column prop="type" align="center" label="设备类型" width="150">
        </el-table-column>
        <el-table-column prop="status" align="center" label="运行状态" width="150">
        </el-table-column>
        <el-table-column prop="uploadspeed" align="center" label="上行速率" width="150">
        </el-table-column>
        <el-table-column prop="downloadspeed" align="center" label="下行速率" width="150">
        </el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      drawLine() {
        var trafficCapacity = this.$echarts.init(document.getElementById('trafficCapacity'))
        ...
        var uploadSpeed = this.$echarts.init(document.getElementById('uploadSpeed'))
        ...
        var downloadSpeed = this.$echarts.init(document.getElementById('downloadSpeed'))
        ...
        var networkDelay = this.$echarts.init(document.getElementById('networkDelay'))
