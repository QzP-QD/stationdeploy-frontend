<template>
  <div style="margin-top: 40px; width: 100%; border: 1px solid lightgray;">
    <el-row>
      ...
      <el-col
        :span="4"
        style="height:45px; line-height:45px; float: right; font-size: 12px; color: darkgray;"
        >*为必填项</el-col
      >
    </el-row>
    <div style="width: 100%; height: 100%; margin-top: 30px;margin-left: 20px;">
      ...
      >
        <el-row
          type="flex"
          style="height: 80px;line-height:80px; margin-left: 30px; font-weight: 700;"
        >
          事件
        </el-row>
        ...
        <div style="text-align: center; margin-top: 120px; ">
          <el-button @click="resetForm('taskForm')" style="width: 130px;"
            >重置</el-button
          >
          <el-button
            type="primary"
