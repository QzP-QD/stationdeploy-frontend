<template>
  <el-container>
    <el-header>
      ...
      <el-button
        v-show="deviceForm.displayform_index === 0"
        style="width:7%; font-size:10px; display:inline-block;"
        type="primary"
        @click="switch_displayform()"
      >
        切换列表形式
      </el-button>
      <el-button
        v-show="deviceForm.displayform_index === 1"
        style="width:7%; font-size:10px; display:inline-block;"
        type="primary"
        @click="switch_displayform()"
      >
    ...
    <el-main v-show="deviceForm.displayform_index === 0">
      <el-tabs type="card" @tab-click="device_tab_click">
        <el-tab-pane
          v-for="(item, index) of deviceForm.device_data.classification"
          :key="index"
          :label="item"
          :name="item"
        >
          <div
            v-for="(deviceitem, itemid) of divide_data_class(item).slice(
